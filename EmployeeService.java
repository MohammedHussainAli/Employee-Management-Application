...
public class EmployeeService {
	...
	Employee emp1=new Employee(101, "Avinash", 24, "Developer", "IT", 25000);
	Employee emp2=new Employee(102, "Meena", 26, "Tester","CO", 57000);
	Employee emp3=new Employee(103, "Bob", 22, "DevOps Eng","Admin", 5000);
	...
	public void updateEmployee() {
		...
		for(Employee emp:empset) {
			if(emp.getId()==id) {
				...
				emp.setName(name);
				emp.setSalary(sal);
				emp.setDesignation(desiganation);
